	...
	<div class="auction-table-design">
		<div class="auction-table-header">
			<ul>
				...
				<li class="cur-price"><?php esc_html_e( 'Final Price', 'wdm-ultimate-auction' ); ?></li>
				<li class="bid_place"><?php esc_html_e( 'Bids Placed', 'wdm-ultimate-auction' ); ?></li>
				<li class="end-time"><?php esc_html_e( 'Ended On', 'wdm-ultimate-auction' ); ?></li>
			</ul>
		</div>
	</div>
			...
			<ul>
				<li class="product_single_auction_thumb prod_img">
					...
					<?php
						...
						if ( 
                            ( ! is_null( $auc_thumb ) && strstr( $auc_thumb, 'youtube.com' ) ) || 
                            ( ! is_null( $auc_thumb ) && strstr( $auc_thumb, 'youtu.be' ) ) 
                        ) {
                            preg_match(
				...
				<li class="cur-price">
					<strong class="show-in-mobile hide-in-desktop"><?php esc_html_e( 'Final Price', 'wdm-ultimate-auction' ); ?>: </strong>
				...
				<li class="bid_place">
					...
					$get_bids = $GLOBALS['wpdb']->get_var($wpdb->prepare(
						"SELECT COUNT(bid) FROM {$wpdb->prefix}wdm_bidders WHERE auction_id = %d",
						$auctionid
					));
				...
				<li class="end-time">
					<strong class="show-in-mobile hide-in-desktop"><?php esc_html_e( 'Ended On', 'wdm-ultimate-auction' ); ?>: </strong>
					<?php
